								...
								<div id="sesiones">
									<div  id="sesion_1">
											...
											<tr id="accionRow_1_1">
												...
												<td><br><button type="button" id="crearAccion_1_1" class="btn btn-xs btn-success">+</button></td>
												</div>
											</tr>
											</div>
											<tbody>
...
<tr id="accionRow_nsesion_naccion">
	...
	<td><label for="peso">Peso</label><br><g:field id="peso_nsesion_naccion" name="peso" type="number" step="0.1" maxlength="4" min="0" max="500" value="0"/></td>
	...
	<td><br><button type="button" id="crearAccion_nsesion_naccion" class="btn btn-xs btn-success">+</button></td>
</div>
</tr>
</table>
</div>
