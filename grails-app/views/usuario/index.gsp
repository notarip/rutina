		...
		<div id="list-usuario" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="tiempoDisponible" title="${message(code: 'usuario.tiempoDisponible.label', default: 'Tiempo Disponible')}" />
					
						<g:sortableColumn property="naciemiento" title="${message(code: 'usuario.naciemiento.label', default: 'Naciemiento')}" />
				...
				<g:each in="${usuarioInstanceList}" status="i" var="usuarioInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: usuarioInstance, field: "tiempoDisponible")}</td>
					
						<td><g:formatDate date="${usuarioInstance.naciemiento}" /></td>
